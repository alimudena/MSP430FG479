 ...
 * @brief Tests that makes sure that the UART is working properly and sends the values read from the SD16 working with structures created for configuring the different modules.
 *             MSP430FG479
 *           -----------------
 *      /|\ |              XIN|---+
 *       |  |                 |   |
