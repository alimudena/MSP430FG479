/**
 * @test Sample EEG, ECG and Battery
 * @brief Tests that takes samples from all the ADC inputs and checks if the sampled values are correct.
 *             MSP430FG479
 *           -----------------
 *      /|\ |              XIN|---+
 *       |  |                 |   |
...
void setup_SD16A(){
    ...
    // -- Entrada analógica
        ...
        SD16A_configuration.analog_input[3] = ECG; //1: A1 - EEG3
