/**
 * @test Configure the different clocks
 * @brief Test that checks if the clocks are well configured.
 * 
 * @details
 * After programming the platform, the pins associated to the different clocks should present the configured clocks. 
 *             MSP430x47x
 *         -----------------
 *     /|\|              XIN|-
 *      | |                 | 32kHz
