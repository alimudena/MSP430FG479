/**
 * @test UART, SD16 working, N CHANNELS
 * @brief Tests that makes sure that the UART is working properly and sends the values read from the SD16 working with structures
